...
<div id="community-insert">
	...
	<fieldset>
		<legend>후기 작성</legend>
		<form:form modelAttribute="seDTO" autocomplete="on" class="memo-form">
			<input name="se_seq" type="hidden" value='<c:out value="${seDTO.se_seq}" default="1"/>'>
			<form:input path="se_auth" class="in-box" placeholder="작성자 ID" /><br />
			<form:input path="se_date" class="in-box" placeholder="작성일자" /><br />
			<form:input path="se_subject" class="in-box" placeholder="제목을 입력하세요" /><br />
			<form:textarea path="se_text" rows="5" placeholder="내용을 입력하세요" /><br />
